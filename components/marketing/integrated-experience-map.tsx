...
export function IntegratedExperienceMap() {
  ...
  return (
    <div className="w-full space-y-0">
      ...
      <div className="grid grid-cols-5 gap-0 border border-white/6 rounded-2xl overflow-hidden mb-16">
        {DOMAINS.map((domain, i) => {
          ...
          return (
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className={`p-6 flex flex-col cursor-pointer ${i < 4 ? "border-r border-white/6" : ""}`}
            >
              <motion.p
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-[200px_1fr_300px] gap-0 items-center border border-white/6 rounded-2xl overflow-hidden">
          {/* Domain label list */}
          <div className="bg-[#09111a] border-r border-white/6 py-8 px-6 flex flex-col justify-center h-[240px]">
            {DOMAINS.map((domain) => {
              const hl = isDomainHighlighted(domain.id);
              return (
                <motion.div
          ...
          <div className="bg-[#09111a] relative h-[240px]">
          ...
          {/* Sparkline + level */}
          <div className="bg-[#09111a] border-l border-white/6 p-8 h-[240px] flex flex-col justify-between">
            <div>
