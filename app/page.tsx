  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-background text-foreground">
      ...
      <section className="relative min-h-[100vh] overflow-hidden border-b border-white/8">
        ...
        <div className="absolute inset-x-0 top-0 z-10 px-6 md:px-12 py-6 md:py-8">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100vh] max-w-[1560px] flex-col items-center justify-center px-6 md:px-12 pb-10 md:pb-14 pt-20 md:pt-24 text-center">
          <ScrollReveal delay={0.1} className="flex w-full flex-col items-center justify-center">
            <div className="mb-10 inline-flex items-center rounded-full border border-[#ff6200]/25 bg-[#ff6200]/10 px-4 py-2.5 text-xs text-center uppercase tracking-[0.15em] md:tracking-[0.24em] text-[#ff6200] backdrop-blur-md shadow-[0_0_24px_rgba(255,98,0,0.15)] transition-colors hover:border-[#ff6200]/40">
      ...
      <section className="border-y border-white/8 bg-[#0a0f16]">
        <ScrollReveal className="mx-auto max-w-[1560px] px-6 md:px-12 py-16 md:py-24">
          <div className="text-center mb-16 md:mb-20 max-w-[800px] mx-auto">
            ...
            <h2 className="text-3xl md:text-[40px] font-bold text-white leading-[1.05] tracking-tight mb-6">
              AI breaks down your goals. You execute. The bar moves.
            </h2>
            <p className="text-base md:text-[18px] text-white/50 leading-relaxed font-light">
      ...
      <section className="mx-auto max-w-[1560px] px-6 md:px-12 py-16 md:py-24 border-b border-white/8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
          <ScrollReveal delay={0.1}>
            <p className="text-sm uppercase tracking-[0.24em] text-[#ff6200]">The Fragmented Mind</p>
            <p className="mt-3 md:mt-4 text-base md:text-[19px] leading-8 text-white/72 font-light">
      ...
      <section className="mx-auto max-w-[1560px] px-6 md:px-12 py-20 md:py-28">
        <ScrollReveal>
          <ConvictionsAccordion />
        </ScrollReveal>
      </section>

      <section className="mx-auto max-w-[1560px] px-6 md:px-12 py-20 md:py-32 border-t border-white/8 bg-[#090d14]">
        <ScrollReveal className="mx-auto max-w-[840px]">
          ...
          <h2 className="mt-6 md:mt-8 text-[32px] md:text-[48px] font-semibold leading-[1.05] tracking-[-0.04em] text-white">
            Most of us live in bad faith — play-acting as objects at the mercy of circumstance.
          </h2>
          
          <div className="mt-10 md:mt-12 space-y-6 md:space-y-8 text-lg md:text-[22px] leading-[1.6] text-white/70 font-light">
            <p>
      ...
      <section className="border-t border-white/8 bg-[#07090d]">
        <ScrollReveal className="mx-auto max-w-[1560px] px-6 md:px-12 py-20 md:py-32">
          <div className="mx-auto max-w-[980px] rounded-2xl border border-[#ff6200]/25 bg-[radial-gradient(circle_at_top,rgba(255,98,0,0.12),transparent_45%),#0b0e14] px-6 md:px-10 py-12 md:py-16 text-center shadow-[0_0_60px_rgba(255,98,0,0.12)]">
            <p className="text-xs uppercase tracking-[0.24em] text-[#ff6200] mb-6">The Final Inquiry</p>
            <h2 className="text-4xl md:text-[56px] font-semibold leading-[1.02] tracking-[-0.05em] text-white max-w-[820px] mx-auto mb-6">
              Are you ready to stop eluding your life and start living it?
            </h2>
            <p className="text-lg md:text-xl text-white/55 leading-relaxed max-w-[600px] mx-auto mb-10 md:mb-12 font-light">
